      ...
      <div style={{ maxWidth: '560px', margin: '0 auto', padding: '100px 24px 60px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--muted)', fontSize: '14px' }}>
            Your public profile is visible to everyone on Sharpd.
          </p>
        </div>
        ...
        <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <span style={{
                  ...
                  color: 'var(--dim)', fontFamily: 'var(--font-mono)', fontSize: '14px'
                }}>@</span>
                <input
                  value={form.username}
              ...
              <p style={{ fontSize: '11px', color: 'var(--dim)', marginTop: '5px', fontFamily: 'var(--font-mono)' }}>
                Only letters, numbers and underscores. This is your public URL: sharpd.bet/u/{form.username || 'username'}
              </p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell people about your betting style, approach, or anything else..."
                maxLength={160}
                rows={3}
          ...
          {message && (
            <div style={{
              ...
              border: `1px solid ${isError ? 'rgba(248,113,113,0.25)' : 'rgba(34,197,94,0.25)'}`,
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button type="submit" className="btn-submit" style={{ flex: 1 }} disabled={saving}>
